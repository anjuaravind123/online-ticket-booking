  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000">
    ...
    <tr>
      ...
      <td colspan="5" rowspan="8" background="pic/step3.jpg"><p class="style9">Aswathy:</p>
        <p class="style9">Aswathy  Theatre is the smallest theatre in SL theatre complex. It has a seating  capacity of about 125 people. The features of Aswathy theatre includes digital sound  quality and good picture quality with UFO and CUBE technology. It has 55 balcony seats and 70 reserved seats. It has air conditioned hall and 35mm screen. </p>
        <p class="style9">&nbsp;</p>        </td>
    ...
    <tr>
      <td height="58" colspan="2"><div align="center"><a href="athulya.php"><strong></strong></a></div>        <a href="athulya.php"><strong><a href="Athulya.php">
    ...
    <tr>
      <td height="54" colspan="2"><div align="center"><a href="Athira.php"><strong>ATHIRA</strong></a></div></td>
      <td>&nbsp;</td>
      <td rowspan="3">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="46" colspan="2"><div align="center"><a href="Aswathy.php"><strong>ASWATHY</strong></a></div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
