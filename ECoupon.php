...
<div id="Layer1">
  ...
  <p>&nbsp;</p>
  <p> <table width="30%" border="0" align="right" cellpadding="1" cellspacing="1">
    <tr>
  ...
  <table width="68%" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th height="51" colspan="6" background="pic/CURTAIN.JPG" scope="row"><div align="left" class="style4">3 Convenient Premium Packages to Choose From! </div></th>
    </tr>

    <tr>
      <th width="33%" height="51" scope="row"><span class="style24">
        <label>
        <input type = "checkbox" name = "chk1[]"   value="400"/>
        </label>
        <img src="pic/Membership_rupees-big-transparent.gif" alt="Rs." title="Rs." vspace="0" width="10" border="0" height="13" hspace="0" /> 400 </span></th>
      <td width="33%"><div align="center" class="style24">
          <label>
          <input type = "checkbox" name = "chk1[]" value=800 />
          </label>
          <strong><img src="pic/Membership_rupees-big-transparent.gif" alt="Rs." title="Rs." vspace="0" width="10" border="0" height="13" hspace="0" /> 800 </strong></div></td>
      <td width="33%"><div align="center" class="style24">
          <label>
          <input type = "checkbox" name = "chk1[]"  value="1200"/>
          </label>
          <label for="productCode3"><strong><img src="pic/Membership_rupees-big-transparent.gif" alt="Rs." title="Rs." vspace="0" width="10" border="0" height="13" hspace="0" /> 1200 </strong></label>
      </div></td>
    </tr>
  </table>
  <table width="36%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th height="40" scope="col"><input type="submit" name="Submit" value="Go" /></th>
    </tr>
  </table>
  <p align="center">&nbsp;</p>
  <p>&nbsp;</p>
