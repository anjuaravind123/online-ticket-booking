...
<body>
<form name="form1" method="post" action="commentdel.php">
<?php
...
<div id="Layer1">
  ...
  s
  <p align="center"><strong><span class="style8"><U>VIEW COMMENTS</U></span></strong></p>
  <p>&nbsp;</p>
  <table width="712" height="58" border="1" align="center" cellpadding="0" bordercolor="#FF0000">
    <tr>
      <td width="61" height="21"><div align="center" class="style7 style24">Select</div></td>
      <td width="283"><div align="center" class="style26">Comments</div></td>
      <td width="161"><div align="center" class="style26">Name</div></td>
      <td width="187"><div align="center" class="style26">E-mail ID </div></td>
      <td width="187"><div align="center" class="style24"><strong>Date &amp; Time</strong> </div></td>
    </tr>
    <?php while($row=mysql_fetch_array($res))
	{ ?>
    <tr>
      <td height="22" bgcolor="#000000"><div align="center">
          <input name="rid" type="radio" value="<?php echo $row['Id'];?>" />
      </div></td>
      <td bgcolor="#000000"><span class="style7"><?php echo $row['comments'];?></span></td>
      <td bgcolor="#000000"><div align="center" class="style7"><?php echo $row['Name'];?></div></td>
      <td bgcolor="#000000"><div align="center" class="style7"><?php echo $row['Emailid'];?></div></td>
      <td bgcolor="#000000"><div align="center" class="style7"><?php echo $row['Date'];?></div></td>
    </tr>
    <?php
	}
	?>
  ...
  <p class="style28"><a href="admin_mainpage.php">&gt;&gt;BACK</a></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
