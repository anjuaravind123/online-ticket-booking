...
$qry="insert into tickets(seats,amount,theatreid,showid,date,bookingdate,userid)values('$seats1','$amount',2,$showid,'$date',now(),'$userid')";
...
{
header("location:seat_aswathy.php");
}
?>
</body>
</html>
