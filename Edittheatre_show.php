...
<body>
<form action="Edittheatre_showprocess.php" method="post" enctype="multipart/form-data" name="form1">
<?php
//session_start();
...
<div id="Layer1">
  ...
  <table width="100%" height="617" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td><input type="text" name="t2" value="<?php echo $row['Theatre_name'];?>" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td class="style15">&nbsp;</td>
      <td class="style15">Startdate</td>
      <td><input name="startdate" type="text" id="startdate"  value="<?php echo $row['Date'];?>"/></td>
      <td colspan="4" rowspan="5" valign="top">&nbsp;<?php echo "<img src=$row[Photo] width=300 height=200      />";?>
	  
	  <a href="changephoto.php?editid=<?php echo $_GET['editid'];?>">Change Photo</a>
	  </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td>&nbsp;</td>
      <td class="style15">&nbsp;</td>
      <td class="style15">Enddate</td>
      <td><input name="enddate" type="text" id="enddate" value="<?php echo $row['enddate'];?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="33">&nbsp;</td>
      ...
      <td><input type="text" name="t3" value="<?php echo $row['Shows'];?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="47">&nbsp;</td>
      ...
      <td>
          ...
          <div align="left" class="style15">Show Time </div></td>
      <td><input type="text" name="t4" value="<?php echo $row['showtime'];?>" />
    ...
    <tr>
      ...
      <td><input type="text" name="t5" value="<?php echo $row['Film_name'];?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <!--<tr>
      <td height="39">&nbsp;</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td class="style15">Film Description&nbsp;</td>
      <td><textarea name="Film_description" cols="50" rows="10" id="Film_description"><?php echo $row['Film_Description'];?></textarea>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
