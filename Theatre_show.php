...
mysql_select_db("theatremanagementsystem");
  ...
  <table width="87%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF0000">
    <tr>
      ...
      <td width="17%"><div align="center" class="style18">Photo</div></td>
      <td width="17%"><div align="center" class="style19">Edit</div></td>
    </tr>
    ...
    <tr>
      ...
      <td><div align="center" class="style8"><?php echo $row['Photo'];?></div></td>
      <td><div align="center"><a href="Edittheatre_show.php?editid=<?php echo $row['showid'];?>">Click Here </a></div></td>
    </tr>
	 <?php
	}
	?>
