...
<body>
<form name="form1" method="post" action="feedbackdel.php">
<?php
...
<div id="Layer1">
  ...
  s
  <p align="center"><strong><span class="style8"><U>VIEW FEEDBACK </U></span></strong></p>
  <p>&nbsp;</p>
  <table width="712" height="58" border="1" align="center" cellpadding="0" bordercolor="#FF0000">
    ...
    <tr>
      <td height="22" bgcolor="#000000"><div align="center">
          <input name="rid" type="radio" value="<?php echo $row['Fid'];?>" />
      </div></td>
      <td bgcolor="#000000"><div align="center" class="style27"><?php echo $row['Feedback'];?></div></td>
