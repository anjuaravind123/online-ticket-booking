...
<div id="Layer1">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000">
    <tr>
      ...
      <td width="12%">&nbsp;</td>
      <td colspan="6"><div align="center" class="style10">ASWATHY</div></td>
      <td width="12%">&nbsp;</td>
      <td width="5%">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="45" colspan="2"><div align="center"><span class="style11">O</span><span class="style11">ur Other Theatres </span></div></td>
      <td>&nbsp;</td>
      <td colspan="5" rowspan="8" background="pic/step3.jpg"><p class="style9">Aswathy:</p>
        <p class="style9">Aswathy  Theatre is the smallest theatre in SL theatre complex. It has a seating  capacity of about 300 people. The features of Aswathy theatre includes digital sound  quality and good picture quality with UFO and CUBE technology.There are two circles  available - friend circle and the rear circle.Balcony feature is not available here. Friend  circle Rs 30 and Rear circle Rs35<strong>.</strong></p>
        <p class="style9">&nbsp;</p>        </td>
      <td rowspan="3"><img src="pic/dublin4.jpg" width="250" height="175" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="42" colspan="2"><div align="center"><a href="Anjaly_admin.php"><strong>ANJALI</strong></a></div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="58" colspan="2"><div align="center"><a href="Athulya_admin.php">
        <div align="center">ATHULYA</div>
        </strong></a></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="54" colspan="2"><div align="center"><a href="Athira_admin.php"><strong>ATHIRA</strong></a></div></td>
      <td>&nbsp;</td>
      <td rowspan="3">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="46" colspan="2"><div align="center"><a href="Aswathy_admin.php"><strong>ASWATHY</strong></a></div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
