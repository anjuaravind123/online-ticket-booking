...
--
-- Host: localhost
-- Generation Time: Mar 23, 2014 at 11:04 AM
...
(8888, 7777, 'anu', 2275887, '2014-05-18', 10000, 0),
(9999, 9999999999999999, 'Vyshak', 6578, '2010-11-30', 98800, 6),
(12345, 33333333333333333, 'Ashwin', 2147483647, '0000-00-00', 20000, 9),
(123415, 148, 'anu', 2147483647, '0000-00-00', 19100, 11),
(11223344, 1234, 'sahib', 1234567890, '2014-04-10', 19850, 13),
...
CREATE TABLE IF NOT EXISTS `ecoupon` (
...
(9, 'Ashwin', 'Alex', 'ashwinabu@gmail.com', 'november1990', 'Anchal', 'Kerala', 'Trivandrum', 691310, 'Govt. Employee', '1990-11-09', 'Male', 2275034, 9745405188, 9995757667, 'What is your name?', 'Ashwin', 0),
...
(13, 'sahib', 'sahib', 'sahib@m.com', 'sahib', 'kollam', 'Kerala', 'Kollam', 875467, 'Engineer', '1972-07-17', 'Male', 764653, 1234567890, 90, 'What is your name?', 'sahib', 0);
...
CREATE TABLE IF NOT EXISTS `theatre_shows` (
...
(44, 'i10,i9,a9', 150, 1, 44, '2014-03-23', '2014-03-23', 13);
